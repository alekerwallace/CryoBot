...
def register_blackjack_command(client):
    ...
    async def blackjack(interaction: discord.Interaction):
        title = "Blackjack" # Default value, raising so it is accessed at the correct time
        ...
        while True:
            ...
            # Update title at the end of the loop so it's ready when the loop starts over
            print(message.embeds)  # Debugging line
            if message.embeds:
